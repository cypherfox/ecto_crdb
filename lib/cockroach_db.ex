defmodule Ecto.Adapters.CockroachDB do
  ...
  It is basically a copy of the PostgrSQL adapter from ecto_sql with minimal required 
  changes made to make it work with CockroachDB.
  ...
  def lock_for_migrations(meta, opts, fun) do
	...
	# This type of table level locking is not required in CRDB, as all transactions are serializable.
        fun.()
      end)
